...
<body class="user-light-grey">
	...
	<div class="user-content" style="min-height: 200px;">
		<div class="container">
			<h2>Flight from  ${flight.from} to ${flight.to}</h2>
			<div class="card">
	...
	<footer class="user-container user-center user-margin-top">
		...
		<div class="col">
			<a
				href="https://images.pexels.com/photos/34145/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				data-toggle="lightbox" data-gallery="example-gallery" class="-2">
				<img
				src="https://images.pexels.com/photos/34145/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				class="col-sm-2">
			</a>
		</div>
		<div class="col">
			<a
				href="https://images.pexels.com/photos/804463/pexels-photo-804463.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				data-toggle="lightbox" data-gallery="example-gallery" class="">
				<img
				src="https://images.pexels.com/photos/804463/pexels-photo-804463.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				class="col-sm-2">
			</a>
		</div>
		<div class="col">
			<a
				href="https://images.pexels.com/photos/2069/people-sign-traveling-blur.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				data-toggle="lightbox" data-gallery="example-gallery" class="">
				<img
				src="https://images.pexels.com/photos/2069/people-sign-traveling-blur.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				class="col-sm-2">
			</a>
		</div>
		<div class="col">
			<a
				href="https://images.pexels.com/photos/34134/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				data-toggle="lightbox" data-gallery="example-gallery" class="">
				<img
				src="https://images.pexels.com/photos/34134/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				class="col-sm-2">
			</a>
		</div>
			<div class="col">
			<a
				href="https://images.pexels.com/photos/62623/wing-plane-flying-airplane-62623.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				data-toggle="lightbox" data-gallery="example-gallery" class="">
				<img
			...
			<div class="col">
			<a
				href="https://images.pexels.com/photos/527/man-person-people-train.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				data-toggle="lightbox" data-gallery="example-gallery" class="">
				<img
				src="https://images.pexels.com/photos/527/man-person-people-train.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
				class="col-sm-2">
			</a>
		</div>
	</footer>
